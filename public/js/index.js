var Thai_menu = {
                    "Paupia":["crispy", "vegetable", "rolls",],	 	 	
                    "Paupia Sod":["fresh roll","vegetables","tofu", "peanuts", "chili", 
                      "lime vinaigrette",],
                    "Kao Pode Tod":["thai spiced corn fritters", "cool cucumber", 
                      "crushed peanuts", "salad",],
                    "Keow Wan Roti":["grilled", "indian bread", "eggplant", "bell peppers", 
                      "basil", "green curry dipping",],	 	 
                    "Basil Panstickers":["pan-fried dumplings", "shrimp", "pork", "thai ginger", 
                      "soy",],	 	 	
                    "Tod Mun thai":["spiced", "fish cakes", "yard long beans", "nuts", 
                      "cucumber vinaigrette",],
                    "Goong Gra Bog":["crispy", "wrapped whole tiger prawns", "sweet chili", 
                      "vinaigrette",],	 
                    "Toong Tong":["golden pouches", "crab", "pork", "salad", "cucumber",
                      "pineapple",],
                    "Plamuk Tod":["fried", "calamari","sriracha", "chili vinaigrette",],
                    "Kanom Pak Gard":["turnip cakes", "stir-fried", "beansprouts", "chives", 
